  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="ml-64 p-8">
        ...
        {currentView === 'dashboard' && <Dashboard showToast={showToast} setCurrentView={setCurrentView} />}
...
// Dashboard Page
function Dashboard({ showToast, setCurrentView }) {
      ...
      <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
        ...
        <div className="grid grid-cols-3 gap-4">
          <button 
            ...
            className="p-6 border-2 border-dashed border-gray-300 rounded-lg hover:border-blue-500 hover:bg-blue-50 transition"
          >
